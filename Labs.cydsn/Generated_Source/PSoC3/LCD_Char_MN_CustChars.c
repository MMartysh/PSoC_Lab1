/*******************************************************************************
* File Name: LCD_Char_MN_CustChars.c
* Version 2.20
*
* Description:
...
void LCD_Char_MN_LoadCustomFonts(uint8 const customData[]) 
{
    ...
    */
    LCD_Char_MN_WriteControl(LCD_Char_MN_CGRAM_0);

    /* Load in the 64 bytes of CustomChar Data */
    for(indexU8 = 0u; indexU8 < LCD_Char_MN_CUSTOM_CHAR_SET_LEN; indexU8++)
    {
        LCD_Char_MN_WriteData(customData[indexU8]);
    }

    LCD_Char_MN_IsReady();
    LCD_Char_MN_WriteControl(LCD_Char_MN_DDRAM_0);
}
